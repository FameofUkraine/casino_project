...
<div class="main-content">
    <div class="container">
        <div class="row">
                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        <header class="entry-header text-center text-uppercase">
                            <h6><a href="#"><?= $article->category ?$article->category->title : 'Article don\'t have category'?></a></h6>
            ...
            <div class="col-md-4" data-sticky_columnF>
                    ...
                    <aside class="widget border pos-padding">
                        ...
                        <?php foreach ($categories as $category): ?>
                            <li>
                                ...
                                <span class="post-count pull-right"> (<?= $category->getArticles() !== null ? $category->getArticles()->count(): 0;?>)</span>
                            </li>
                        <?php endforeach ?>
